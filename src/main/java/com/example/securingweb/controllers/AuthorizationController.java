...
public class AuthorizationController {
    ...
    public String singIn(HttpServletResponse response, @RequestBody UsernamePasswordRequestBody body) throws IOException {
        ...
        JsonWebToken secureToken = secureJsonWebTokenService.generateOncePerRequestToken();
        response.addCookie(cookieService.createLongTermCookie(jsonWebToken));
        response.addCookie(cookieService.createOncePerRequestCookie(secureToken));
